...
public class Menu {
    ...
    public static void displaymenu()
    {
        ...
        System.out.println("err - mark an item that needs to be done everyday/week");
        ...
        System.out.println("ls_err - list all the items that needs to be done everyday/week");
